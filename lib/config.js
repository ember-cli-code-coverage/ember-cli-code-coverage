 ...
 * @property {String} covfefeEnvVar - name of environment variable for covfefe
 * @property {String} covfefeFolder - directory in which to write covfefe to
...
function config(configPath) {
  ...
  var configFile = path.resolve(path.join(configDirName, 'covfefe.js'));
