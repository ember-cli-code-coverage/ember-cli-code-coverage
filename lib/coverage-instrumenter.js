...
CoverageInstrumenter.prototype.processString = function(content, relativePath) {
  ...
  try {
    ...
    console.error('Unable to cover:', relativePath, '. Newer JS features may need Babel instumentation to work. Try setting useBabelInstrumenter to true in your config/coverage.js.\n', e.stack);
  }
};
