...
CovfefeInstrumenter.prototype = Object.create(Filter.prototype);
CovfefeInstrumenter.prototype.constructor = CovfefeInstrumenter;
function CovfefeInstrumenter(inputNode, options) {
  options = options || {};
...
CovfefeInstrumenter.prototype.extensions = ['js'];
CovfefeInstrumenter.prototype.targetExtension = 'js';

CovfefeInstrumenter.prototype.processString = function(content, relativePath) {
  var instrumenter
  ...
  try {
    ...
    console.error('Unable to cover:', relativePath, '. Newer JS features may need Babel instumentation to work. Try setting useBabelInstrumenter to true in your config/covfefe.js.\n', e.stack);
  }
};

module.exports = CovfefeInstrumenter;
