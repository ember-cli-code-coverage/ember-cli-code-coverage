import gjsGtsIstanbulIgnoreTemplatePlugin from '../packages/ember-cli-code-coverage/src/babel/gjs-gts-istanbul-ignore-template-plugin.cjs';
...
describe('gjs-gts-ignore-template-plugin', () => {
  it('it adds istanbul ignore comment before "template" invocation if template is imported from "@ember/template-compiler"', async () => {
    const example = processor.process(
    ...
    const { code } = babel.transform(example, {
      plugins: [gjsGtsIstanbulIgnoreTemplatePlugin],
      filename: 'some-file.gjs',
    });
